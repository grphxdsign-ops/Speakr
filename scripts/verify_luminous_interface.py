...
REQUIRED_EVIDENCE_TESTS = {
    ...
    "privacy_and_outbound_boundary": (
        ...
        "tests.test_artifact_privacy_scan.ArtifactPrivacyScanTests.test_rejects_remote_urls_in_ui_config_text_and_archive_but_allows_loopback",
        "tests.test_artifact_privacy_scan.ArtifactPrivacyScanTests.test_rejects_browser_engine_and_addons_names_on_both_platforms",
        "tests.test_artifact_privacy_scan.ArtifactPrivacyScanTests.test_release_environment_is_essentials_only",
        "tests.test_artifact_privacy_scan.ArtifactPrivacyScanTests.test_allows_transitive_qtnetwork_files_but_rejects_app_api_import",
        "tests.test_release_core_proof.CoreReleaseProofTests.test_socket_guard_blocks_dns_before_resolution_and_allows_localhost",
        "tests.test_release_core_proof.CoreReleaseProofTests.test_application_lifecycle_publishes_real_model_and_formatter_events",
        "tests.test_release_manifest.ReleaseManifestTests.test_manifest_binds_source_artifact_lock_signature_and_receipts",
